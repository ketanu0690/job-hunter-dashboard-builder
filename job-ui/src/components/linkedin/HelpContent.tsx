  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Guide to automating your job applications
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div>
          ...
          <ol className="list-decimal ml-5 space-y-2">
            ...
            <li>
              Define job positions you're looking for (separated by commas)
            </li>
        ...
        <div>
          ...
          <ul className="list-disc ml-5 space-y-2">
            ...
            <li>
              You may receive LinkedIn security checks if applying to many jobs
            </li>
            <li>
              The automation runs on our secure server and will continue even if
              you close this page
            </li>
