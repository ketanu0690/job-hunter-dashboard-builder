...
import { AuthProvider, useAuth } from "../components/forms/AuthForm";
          ...
          <main className="flex-1 container mx-auto px-4 py-6 max-w-screen-xl">
            <div className="mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Track tech job postings matching your preferred companies and
                skills
              </p>
            </div>
                ...
                <div className="max-w-md mx-auto">
                  ...
                  <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                    ...
                    <ol className="list-decimal ml-5 space-y-2 text-sm">
                      ...
                      <li>
                        Set up an action in Zapier (email, Slack notification,
                        etc.)
                      </li>
