...
const AppFooter = () => {
  ...
  return (
    <footer
      className={`py-12 ${theme === "dark" ? "bg-gray-900" : "bg-slate-900"} text-white`}
    >
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground mb-6">
              Empowering tech professionals to find their dream job through an
        ...
        <div className="mt-16 pt-8 border-t border-accent flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} KetanOnePlatform. All rights reserved.
          </p>
